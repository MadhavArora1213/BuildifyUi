      ...
      <div className="toggle-cont">
        ...
        <label className="toggle-label" htmlFor="toggle">
          <div className="cont-icon">
            <span style={{ width: '2px', '--deg': 25, '--duration': 11 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 100, '--duration': 18 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 280, '--duration': 5 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 200, '--duration': 3 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 30, '--duration': 20 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 300, '--duration': 9 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 250, '--duration': 4 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 210, '--duration': 8 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 100, '--duration': 9 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 15, '--duration': 13 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 75, '--duration': 18 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 65, '--duration': 6 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 50, '--duration': 7 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 320, '--duration': 5 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 220, '--duration': 5 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 215, '--duration': 2 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 135, '--duration': 9 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 45, '--duration': 4 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 78, '--duration': 16 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 89, '--duration': 19 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 65, '--duration': 14 }} className="sparkle" />
            <span style={{ width: '2px', '--deg': 97, '--duration': 1 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 174, '--duration': 10 }} className="sparkle" />
            <span style={{ width: '1px', '--deg': 236, '--duration': 5 }} className="sparkle" />
